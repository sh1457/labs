...
global ns nf tr
	...
	close $tr
	close $nf
	exec xgraph -lw 2 -bg white sim5_1.xg -geometry 600*600 &
	exec xgraph -lw 2 -bg white sim5_2.xg -geometry 600*600 &
	exit 0	
}
...
set outFile50 [ open sim5_1.xg w ]
set outFile51 [ open sim5_2.xg w ]
